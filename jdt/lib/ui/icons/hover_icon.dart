...
/* ------------------------------- GenericIcon ------------------------------ */
/// Extends the [JdtIcon] class. [HoverIcon] is an animated icon which has an intro
/// animation which plays on load, and a hover animation. The effect stops when the
/// user clicks on the icon.
class HoverIcon extends JdtIcon {
  HoverIcon({
    super.key,
  ...
  @override
  State<HoverIcon> createState() => _GenericIconState();
}

class _GenericIconState extends State<HoverIcon> with TickerProviderStateMixin {
